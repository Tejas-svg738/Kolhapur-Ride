...
<script>
    ...
    <div class="container">
      <div class="text">
        <h1 style="font-size: 60px; color:#33333;" >OUR SERVICES</h1>
        <p style="font-size: 30px;">Simple Rides, Smart Travel.</p>
      </div>
      <div class="image">
        <img src="servicesmain.jpg" alt="jpg">
      </div>
    </div>
    <!-- card -->
    <h1 style="margin-left: 50px; font-size: 30px; color:#333333;">We Are Provides Services</h1>
    <div class="container2">
      <div class="card">
        <img src="servicvesride for other.jpg" alt="Nature">
        <div class="card-content">
          <h3 style="color:#666666;">Ride For Others</h3>
      ...
      <div class="card">
        <img src="Bu qutular 2.jpg" alt="Adventure" style="padding: 20px;">
        <div class="card-content">
          <h3 style="color:#666666;">Flexible Gift Solutions</h3>
          
        </div>
      </div>

      <div class="card">
        <img src="download (16)2.jpg" alt="City Life" style="padding: 10px;" >
        <div class="card-content">
          <h3 style="color:#666666;">Courier</h3>
    ...
    <!-- disply block -->
    <h1 style="margin-left:80px; font-size: 35px; color:#333333">How companies leverage for Business</h1>
    <div class="container3">
      <div class="card3" style="margin-left: 70px;">
        <!-- <img src="icons8-beach-94.png" style="width: 100px; height: 100px; margin-left: 10px;"> -->
        <i class="bi bi-luggage"></i>
        <div class="card-content">
          <h3>Send Rides With Central</h3>
          <p style="margin-top: 10px;">Use the Central dashboard to request rides for
            customers and guests even if they don't
            have a smartphone.</p>
      ...
      <div class="card3" style="margin-right: 140px;">
        <!-- <img src="icons8-motorcycle-94.png" alt="City Life"> -->
        <div class="card-content">
          <h3>Bussiness Travel</h3>
          <p style="margin-top:10px ;">It facilitates networking, expands market reach, fosters collaboration, and allows for in-person interactions. </p>

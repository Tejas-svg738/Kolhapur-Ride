...
<script>
  ...
  <div class="container">
    <h1>What’s your business email?</h1>
    <form>
      <label for="email">Business email</label>
      <input type="email" id="email" placeholder="Enter business email address" required />
      <button id="btn" type="submit"  value="onclick">Submit</button>
    </form>
